...
from dataset.SASRec.python.model import SASRec
from dataset.SASRec.python.utils import *
import json
...
if __name__ == '__main__':
    ...
    print('args.batch_size,num_batch',args.batch_size,num_batch)
    cc = 0.0
    for u in user_train:
        cc += len(user_train[u])
    ...
    if not (args.inference_only or args.tokenize_only):
        ...
        for epoch in tqdm(range(epoch_start_idx, args.num_epochs + 1)):
            ...
            if epoch == args.num_epochs:
                ...
                torch.save(model.state_dict(), os.path.join(folder, fname))
                torch.save(model.state_dict(), os.path.join(folder, args.savename))
